...
import MintBearlieverButton from "./MintBearlieverButton";

interface MintBearlieverProps {
  address: string;
  keccakQueryResponse: string;
}

export default async function MintBearliever(props: MintBearlieverProps) {
  ...
  return (
    <div>
      <MintBearlieverButton responses={responses} />
    </div>
  )
}